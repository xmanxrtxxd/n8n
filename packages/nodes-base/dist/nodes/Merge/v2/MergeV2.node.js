            ...
            if (combinationMode === 'mergeByFields') {
                ...
                if (joinMode === 'enrichInput1' || joinMode === 'enrichInput2') {
                    ...
                    if (joinMode === 'enrichInput1') {
                        if (clashResolveOptions.resolveClash === 'addSuffix') {
                            returnData = returnData.concat(mergedEntries, (0, utils_1.addSuffixToEntriesKeys)(matches.unmatched1, '1'));
                        }
                        else {
                        ...
                        if (clashResolveOptions.resolveClash === 'addSuffix') {
                            returnData = returnData.concat(mergedEntries, (0, utils_1.addSuffixToEntriesKeys)(matches.unmatched2, '2'));
                        }
                        else {
