...
exports.deleteIssueRequest = exports.updateIssueRequest = exports.getManyIssuesRequest = exports.getIssueRequest = exports.issueCreateRequest = exports.addCommentLink = exports.addCommentWithParentRequest = exports.addCommentRequest = void 0;
...
exports.addCommentWithParentRequest = {
    query: `mutation CommentCreate ($issueId: String!, $body: String!, $parentId: String) {
			commentCreate(input: {issueId: $issueId, body: $body, parentId: $parentId}) {
				success
				comment {
