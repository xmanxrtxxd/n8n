...
exports.fileTypesOptions = [
    ...
    },
    {
        ...
        value: interfaces_1.DRIVE.SDK,
    },
    {
        name: 'Audio',
        value: interfaces_1.DRIVE.AUDIO,
    },
    {
        name: 'Folder',
        value: interfaces_1.DRIVE.FOLDER,
    },
    {
        name: 'Google Apps Scripts',
        value: interfaces_1.DRIVE.APP_SCRIPTS,
    },
    {
        name: 'Google Docs',
        value: interfaces_1.DRIVE.DOCUMENT,
    },
    {
        name: 'Google Drawing',
        value: interfaces_1.DRIVE.DRAWING,
    },
    {
        name: 'Google Forms',
        value: interfaces_1.DRIVE.FORM,
    },
    {
        name: 'Google Fusion Tables',
        value: interfaces_1.DRIVE.FUSIONTABLE,
    },
    {
        name: 'Google My Maps',
        value: interfaces_1.DRIVE.MAP,
    },
    {
        name: 'Google Sheets',
        value: interfaces_1.DRIVE.SPREADSHEET,
    },
    {
        name: 'Google Sites',
        value: interfaces_1.DRIVE.SITES,
    },
    {
        name: 'Google Slides',
        value: interfaces_1.DRIVE.PRESENTATION,
    },
    {
        name: 'Photo',
        value: interfaces_1.DRIVE.PHOTO,
    },
    {
        name: 'Unknown',
        value: interfaces_1.DRIVE.UNKNOWN,
    },
    {
        name: 'Video',
        value: interfaces_1.DRIVE.VIDEO,
    },
];
