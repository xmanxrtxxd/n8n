...
async function execute(index) {
    ...
    const url = GenericFunctions_1.validateUrl.call(this, index);
    ...
    const screenResolution = GenericFunctions_1.validateScreenResolution.call(this, index);
    ...
    response = await transport_1.apiRequest.call(this, 'POST', `/sessions/${sessionId}/windows`, body);
    ...
    if (getLiveView) {
        // Get Window info
        response = await transport_1.apiRequest.call(this, 'GET', `/sessions/${sessionId}/windows/${windowId}`, undefined, {
