...
async function execute(index) {
    ...
    if (bigdata) {
        body.rows = [rowInput];
        const responseData = await GenericFunctions_1.seaTableApiRequest.call(this, {}, 'POST', '/api-gateway/api/v2/dtables/{{dtable_uuid}}/add-archived-rows/', body);
    ...
    // save to normal backend
        ...
        const responseData = await GenericFunctions_1.seaTableApiRequest.call(this, {}, 'POST', '/api-gateway/api/v2/dtables/{{dtable_uuid}}/rows/', body);
