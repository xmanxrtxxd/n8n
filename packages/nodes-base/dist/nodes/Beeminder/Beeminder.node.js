        ...
        for (let i = 0; i < length; i++) {
            try {
                ...
                if (resource === 'datapoint') {
                    ...
                    (0, n8n_workflow_1.assertParamIsString)('goalName', goalName, this.getNode());
...
async function executeDatapointCreate(context, goalName, itemIndex, timezone) {
    ...
    (0, n8n_workflow_1.assertParamIsNumber)('value', value, context.getNode());
...
async function executeDatapointUpdate(context, goalName, itemIndex, timezone) {
    ...
    (0, n8n_workflow_1.assertParamIsString)('datapointId', datapointId, context.getNode());
...
async function executeDatapointCreateAll(context, goalName, itemIndex) {
    ...
    (0, n8n_workflow_1.assertParamIsArray)('datapoints', parsedDatapoints, (val) => typeof val === 'object' && val !== null && 'value' in val, context.getNode());
    const data = {
        goalName,
...
async function executeChargeOperations(context, operation, itemIndex) {
    if (operation === 'create') {
        ...
        (0, n8n_workflow_1.assertParamIsNumber)('amount', amount, context.getNode());
        const options = context.getNodeParameter('additionalFields', itemIndex);
        (0, n8n_workflow_1.validateNodeParameters)(options, {
            note: { type: 'string' },
            dryrun: { type: 'boolean' },
...
async function executeGoalCreate(context, itemIndex, timezone) {
    ...
    (0, n8n_workflow_1.assertParamIsString)('slug', slug, context.getNode());
    const title = context.getNodeParameter('title', itemIndex);
    (0, n8n_workflow_1.assertParamIsString)('title', title, context.getNode());
    const goalType = context.getNodeParameter('goal_type', itemIndex);
    (0, n8n_workflow_1.assertParamIsString)('goalType', goalType, context.getNode());
    const gunits = context.getNodeParameter('gunits', itemIndex);
    (0, n8n_workflow_1.assertParamIsString)('gunits', gunits, context.getNode());
    const options = context.getNodeParameter('additionalFields', itemIndex);
...
async function executeGoalGet(context, itemIndex) {
    ...
    (0, n8n_workflow_1.assertParamIsString)('goalName', goalName, context.getNode());
    const options = context.getNodeParameter('additionalFields', itemIndex);
    (0, n8n_workflow_1.validateNodeParameters)(options, {
